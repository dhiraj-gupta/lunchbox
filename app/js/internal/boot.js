...
module.exports = (function () {
  return {
    ...
    loadSettings: function (dialog) {
      ...
      window.lunchbox.settings = new LunchboxSettings();
      ...
      window.lunchbox.settings.load(function (error, data) {
        if (error !== null) {
    ...
    buildNavigation: function (dialog) {
      ...
      // create core Lunchbox navigation
        var lunchbox_nav = {
          plugin: {
            instance: {
              unique_name: 'lunchbox'
            }
          },
          title: 'Lunchbox',
          items: [
